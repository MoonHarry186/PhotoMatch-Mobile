...
| Verification                | `POST /auth/verify-email`, `/auth/resend-verification`, `/auth/change-pending-email`                                                                 | Ready                                                                               |
| Password recovery           | `POST /auth/forgot-password`, `/auth/reset-password`                                                                                                 | Ready                                                                               |
