...
| --------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------- |
| Bootstrap                   | `POST /auth/refresh`, `GET /me`, `GET /me/restrictions`, `GET /me/onboarding/progress`                                                               | Legal consent is recorded by sign-up/sign-in and is not a bootstrap gate          |
...
| Legal                       | `GET /legal-documents/current`                                                                                                                       | Public Terms/Privacy viewer; no interactive consent flow                          |
